...
public class ByteInputOutput {
	...
	public static void main(String[] args) {
		...
		try (
			...
			/*
			 * //한번에 읽기 //읽을 데이터 개수 가져오기 int len = fis.available(); //읽은 데이터를 저장할 배열을 생성 b =
			 * new byte[len]; //데이터 읽기 fis.read(b); //바이트 배열을 문자열로 변환 String data = new
			 * String(b); System.out.println(data);
			 */
			...
			while (true) {
				...
				// 데이터를 사용할 때 배열을 바로 사용하면 안되고 0부터 읽은 개수만큼만 사용해야합니다.
